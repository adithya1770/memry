...
if(first_pa=="0x00"||second_pa=="0x00"){
  ...
  setTimeout(() => { fill(255); rect(750, 100, 85, 50); fill(0); textSize(16); text("0x00", 750 + 20, 100 + 30); }, 500);
} else {
...
if(first_pa=="0x01"||second_pa=="0x01"){
  ...
  setTimeout(() => { fill(255); rect(835, 100, 85, 50); fill(0); text("0x01", 835 + 20, 100 + 30); }, 500);
} else {
...
if(first_pa=="0x02"||second_pa=="0x02"){
  ...
  setTimeout(() => { fill(255); rect(920, 100, 85, 50); fill(0); text("0x02", 920 + 20, 100 + 30); }, 500);
} else {
...
if(first_pa=="0x03"||second_pa=="0x03"){
  ...
  setTimeout(() => { fill(255); rect(1005, 100, 85, 50); fill(0); text("0x03", 1005 + 20, 100 + 30); }, 500);
} else {
...
if(first_pa=="0x04"||second_pa=="0x04"){
  ...
  setTimeout(() => { fill(255); rect(750, 150, 85, 50); fill(0); text("0x04", 750 + 20, 150 + 30); }, 500);
} else {
...
if(first_pa=="0x05"||second_pa=="0x05"){
  ...
  setTimeout(() => { fill(255); rect(835, 150, 85, 50); fill(0); text("0x05", 835 + 20, 150 + 30); }, 500);
} else {
...
if(first_pa=="0x06"||second_pa=="0x06"){
  ...
  setTimeout(() => { fill(255); rect(920, 150, 85, 50); fill(0); text("0x06", 920 + 20, 150 + 30); }, 500);
} else {
...
if(first_pa=="0x07"||second_pa=="0x07"){
  ...
  setTimeout(() => { fill(255); rect(1005, 150, 85, 50); fill(0); text("0x07", 1005 + 20, 150 + 30); }, 500);
} else {
...
if(first_pa=="0x08"||second_pa=="0x08"){
  ...
  setTimeout(() => { fill(255); rect(750, 200, 85, 50); fill(0); text("0x08", 750 + 20, 200 + 30); }, 500);
} else {
...
if(first_pa=="0x09"||second_pa=="0x09"){
  ...
  setTimeout(() => { fill(255); rect(835, 200, 85, 50); fill(0); text("0x09", 835 + 20, 200 + 30); }, 500);
} else {
...
if(first_pa=="0x0A"||second_pa=="0x0A"){
  ...
  setTimeout(() => { fill(255); rect(920, 200, 85, 50); fill(0); text("0x0A", 920 + 20, 200 + 30); }, 500);
} else {
...
if(first_pa=="0x0B"||second_pa=="0x0B"){
  ...
  setTimeout(() => { fill(255); rect(1005, 200, 85, 50); fill(0); text("0x0B", 1005 + 20, 200 + 30); }, 500);
} else {
...
if(first_pa=="0x0C"||second_pa=="0x0C"){
  ...
  setTimeout(() => { fill(255); rect(750, 250, 85, 50); fill(0); text("0x0C", 750 + 20, 250 + 30); }, 500);
} else {
...
if(first_pa=="0x0D"||second_pa=="0x0D"){
  ...
  setTimeout(() => { fill(255); rect(835, 250, 85, 50); fill(0); text("0x0D", 835 + 20, 250 + 30); }, 500);
} else {
...
if(first_pa=="0x0E"||second_pa=="0x0E"){
  ...
  setTimeout(() => { fill(255); rect(920, 250, 85, 50); fill(0); text("0x0E", 920 + 20, 250 + 30); }, 500);
} else {
...
if(first_pa=="0x0F"||second_pa=="0x0F"){
  ...
  setTimeout(() => { fill(255); rect(1005, 250, 85, 50); fill(0); text("0x0F", 1005 + 20, 250 + 30); }, 500);
} else {
...
if(first_la=="0xA3F12"||second_la=="0xA3F12"){
  ...
  setTimeout(() => { fill(255); rect(370, 100 + 0 * ptCellH, ptCellW, ptCellH); fill(0); text("0xA3F12", 370 + 5, 100 + 0 * ptCellH + 20); }, 500);
} else {
...
if(first_la=="0x1D4B9"||second_la=="0x1D4B9"){
  ...
  setTimeout(() => { fill(255); rect(370, 100 + 1 * ptCellH, ptCellW, ptCellH); fill(0); text("0x1D4B9", 370 + 5, 100 + 1 * ptCellH + 20); }, 500);
} else {
...
if(first_la=="0xFE7C0"||second_la=="0xFE7C0"){
  ...
  setTimeout(() => { fill(255); rect(370, 100 + 2 * ptCellH, ptCellW, ptCellH); fill(0); text("0xFE7C0", 370 + 5, 100 + 2 * ptCellH + 20); }, 500);
} else {
...
if(first_la=="0x09AB7"||second_la=="0x09AB7"){
  ...
  setTimeout(() => { fill(255); rect(370, 100 + 3 * ptCellH, ptCellW, ptCellH); fill(0); text("0x09AB7", 370 + 5, 100 + 3 * ptCellH + 20); }, 500);
} else {
...
if(first_la=="0xC4E1D"||second_la=="0xC4E1D"){
  ...
  setTimeout(() => { fill(255); rect(370, 100 + 4 * ptCellH, ptCellW, ptCellH); fill(0); text("0xC4E1D", 370 + 5, 100 + 4 * ptCellH + 20); }, 500);
} else {
...
for(let i = 5; i < 16; i++){
  ...
  if(first_la==val || second_la==val){
    ...
    setTimeout(() => { fill(255); rect(370, 100 + i*ptCellH, ptCellW, ptCellH); fill(0); text(val, 370+5, 100 + i*ptCellH + 20); }, 500);
  } else {
...
for(let i = 0; i < 16; i++){
  ...
  if(first_la==val || second_la==val){
    ...
    setTimeout(() => { fill(255); rect(370 + ptCellW, 100 + i*ptCellH, ptCellW, ptCellH); fill(0); text(val, 370 + ptCellW + 5, 100 + i*ptCellH + 20); }, 500);
  } else {
